...
public class TestCaseMathOperations {
	...
	@Test
	public void testAdd() {
		int a = 5; //define the input data
		int b = 6;
		int expectedResult = 11; //define what we expect to get
		int actualResult = MathOperations.add(a, b); 
		assertEquals("Check the addition", expectedResult, actualResult); //do the check
	}
